...
A -->B(<font color=0052cc>Create an enterprise object)

click B href "https://wiki.abiquo.com/api/latest/enterprise.html" _blank

B -->C(<font color=0052cc>Create the enterprise)
